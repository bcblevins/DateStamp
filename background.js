...
function prependInitials() {
    ...
    if (
        ...
        if (activeElement.value.substring(3, 17).includes("in progress\n\n")) {
            ...
            let initialsElement = document.querySelector("#header").firstChild.lastChild.firstChild.lastChild.firstChild.firstChild;
            let initials = "";

	    if (initialsElement) {
                 initials = (initialsElement.innerText === "JJ") ? "Q" : initialsElement.innerText;
                 activeElement.value = initials + " in progress" + "\n\n" + activeElement.value;
            } else {
                 activeElement.value = "In progress" + "\n\n" + activeElement.value;
            }
